...
interface ExamOptionToggleProps {
  enabled: boolean;
...
/**
 * Switch-style card for a simulator option shown before the exam starts
 * (e.g. instant feedback, shuffled answers). Generic so each option supplies
 * its own title / description / icon.
 */
export function ExamOptionToggle({
  enabled,
  onChange,
  disabled,
  title,
