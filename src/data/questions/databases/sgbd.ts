...
export const sgbd: Question[] = [
  ...
  },
  {
    ...
    codeLanguage: undefined,
    options: {
      a: `O mulţime finită de operaţii coerente, executate de un SGBD, care manipulează datele unei`,
...
Microsoft SQL Server, ce rol ar trebui să fie asignat unui developer?`,
    ...
    codeLanguage: undefined,
    options: {
      a: `Db-owner a. Nu, pentru că nu aveţi permisiunile cerute pe tabele`,
      b: `Da, dacă aveţi permisiunea EXECUTE pentru procedura stocată`,
      c: `Nu, dacă nu sunteţi membri sysadmin sau db-owner`,
...
Trebuie să împiedicaţi alţi utilizatori să copieze vederea. Ce instrucţiune ar`,
    ...
    options: {
      ...
      b: `Ce instrucţiune ar trebui să folosiţi? a. ALTER VIEW dbo.Employee WITH ENCRYPTION AS SELECT Name FROM dbo.HumanResources WHERE isEmployee = 1`,
...
vedere?`,
  ...
  },
  {
    ...
    options: {
      ...
      c: `Şterge un utilizator al sistemului(pe care ruleaza serverul de )`,
...
(CurrentStock - NumberSold) AS AvailableStock FROM dbo.Products.`,
  ...
  },
  {
    ...
    codeLanguage: undefined,
    options: {
      a: `Înlocuiește toate instanțele de "Linux" cu "UNIX" în fișierul file.txt.`,
      b: `Înlocuiește primul cuvânt "Linux" din fiecare linie cu "UNIX".`,
  ...
  },
  {
    ...
    codeLanguage: undefined,
    options: {
      a: `Verifică dacă portul 4 este deschis pe google.com.`,
      b: `Ping continuu către google.com.`,
  ...
  },
  {
    ...
    codeLanguage: undefined,
    options: {
      a: `Face scriptul executabil automat.`,
      b: `Definește directorul curent de lucru pentru script.`,
      c: `Specifică shell-ul care va interpreta scriptul.`,
  ...
  },
  {
    ...
    options: {
      ...
      b: `tar -cf archive.tar file1.txt`,
      c: `tar -xvf archive.tar file1.txt`,
      d: `tar -cvf archive.tar file1.txt`,
    },
    correctAnswer: "d",
  },
];
