...
numește`,
  ...
  },
  {
    ...
    options: {
      ...
      b: `elementul căutat este pe prima poziție în listă`,
  ...
  },
  {
    ...
    options: {
      ...
      c: `numărul de operații cheie executate`,
...
6) }`,
    ...
    options: {
      ...
      d: `returnează pointer la ultimul nod al listei`,
    },
    correctAnswer: "a",
  },
  {
...
rear = p;  
  ...
  },
  {
    ...
    options: {
      a: `vectorul este deja sortat`,
      b: `vectorul conține elemente nule`,
...
Fig. 3`,
    ...
    options: {
      ...
      c: `Arborele din figura Fig. 3 este un arbore binar de căutare.`,
      d: `Arborele din figura Fig. 3 nu este un arbore binar de căutare.`,
    },
    correctAnswer: "a",
  },
  {
