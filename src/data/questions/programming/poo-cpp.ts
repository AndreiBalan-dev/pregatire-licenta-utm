...
int main(){
  ...
  return 0;
    ...
    codeLanguage: "cpp",
    options: {
      a: `Declarațiile 1, 2 și 3.`,
      b: `Declarațiile 1 si 3;`,
      c: `Declarațiile 1 și 2;`,
      d: `Declarațiile 2 și 4;`,
    },
    correctAnswer: "b",
  },
  {
...
public:
  ...
  },
  {
    ...
    options: {
      ...
      b: `nu se poate realiza polimorfismul dinamic în limbajul C++`,
      c: `claselor derivate`,
      d: `pointerilor și a funcțiilor virtuale`,
    },
    correctAnswer: "d",
  },
  {
...
int main(){
  ...
  },
  {
    ...
    moduleId: "programming",
    subjectId: "poo-cpp",
    text: `O funcție independentă declarată friend în domeniul public dintr-o clasă C++ și care primește ca parametru o referință la un obiect al clasei respective are acces:`,
    code: undefined,
    codeLanguage: undefined,
    options: {
...
int main(){
  ...
  return 0;
    ...
    codeLanguage: "cpp",
    options: {
      a: `eroare, metoda get_x() nu poate fi declarată static;`,
      b: `programul afişează valoarea 221;`,
      c: `eroare, data membră statică x nu este iniţializată;`,
...
int main(){
  ...
  },
  {
    ...
    moduleId: "programming",
    subjectId: "poo-cpp",
    text: `O funcţie independentă declarată friend în domeniul private dintr-o clasă şi care primeşte ca parametru o referinţă la un obiect al clasei respective are acces:`,
    code: undefined,
    codeLanguage: undefined,
    options: {
      a: `doar la membrii publici;`,
      b: `la toti membrii;`,
      c: `la membrii public şi protected;`,
...
int main(){
  ...
  c b=x; x=y;
    ...
    options: {
      ...
      d: `apeleaza de doua ori constructorul de copiere, o data operator=() si o data constructorul implicit;`,
    },
    correctAnswer: "d",
  },
  {
...
int main(){
  ...
  },
  {
    ...
    moduleId: "programming",
    subjectId: "poo-cpp",
    text: `Presupunem că în C++ clasa A este prietenă cu clasa B, iar clasa B este prietenă cu clasa C. Care dintre următoarele afirmații este adevărată?`,
    code: undefined,
    codeLanguage: undefined,
    options: {
      a: `Clasa C devine automat prietenă cu clasa A.`,
      b: `Clasa B nu poate fi prietenă cu nicio altă clasă în afara clasei A.`,
...
int main(){
  ...
  },
  {
    ...
    moduleId: "programming",
    subjectId: "poo-cpp",
    text: `Pentru ca secvența de mai jos să se execute fără erori, precizați care dintre implementările C++ de mai jos, ale unui operator de comparație, este corectă?`,
    code: `class Box{
  int capacity;
public:
  Box(){}
...
int main(){
  ...
  },
  {
    ...
    moduleId: "programming",
    subjectId: "poo-cpp",
    text: `Supraîncărcarea unor operatori în C++ se poate realiza prin funcţii operator sau prin funcţii friend. Una dintre diferențele dintre aceste două posibilități constă în:`,
    code: undefined,
    codeLanguage: undefined,
    options: {
  ...
  },
  {
    ...
    moduleId: "programming",
    subjectId: "poo-cpp",
    text: `Precizați de câte ori se realizează mecanismul de suprascriere și de câte ori mecanismul de supraîncărcare în următoarele clase C++:`,
    code: `class Angajat{
protected:
  int salariu;
public:
...
public:
  ...
  void afiseazaSalariu(int bonus) {
    cout<salariu<<" "<spor<<" "<<bonus;
  }
  int totalSalariu(char* mesaj){
    ...
    codeLanguage: "cpp",
    options: {
      a: `suprascriere și două supraîncărcări`,
      b: `două suprascrieri și o supraîncărcare`,
      c: `suprascriere și o supraîncărcare`,
      d: `trei suprascrieri și o supraîncărcare`,
    },
    correctAnswer: "a",
  },
];
